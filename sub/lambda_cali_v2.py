...
def x_lambda(lamp, c1, c2, c3, plot, x):
    ...
    lamp = 0.5*(np.mean(lamp[0,pixel_mean[0]:pixel_mean[1],:],dtype='d', axis=0)-np.mean(lamp[0,pixel_bg[0]:pixel_bg[1],:],dtype='d', axis=0))
    ...
    slope_max[0,0] = int(*np.where(c1ds == np.max(c1ds[150:230])))
    slope_max[1,0] = int(*np.where(c1ds == np.min(c1ds[150:230])))
    slope_max[2,0] = int(*np.where(c2ds == np.max(c2ds[50:150])))
    slope_max[3,0] = int(*np.where(c2ds == np.min(c2ds[50:150])))
    slope_max[4,0] = int(*np.where(c3ds == np.max(c3ds[50:130])))
    slope_max[5,0] = int(*np.where(c3ds == np.min(c3ds[50:150])))
