...
for n in range(len(pts)):
    ...
    ax[0,4].annotate('$\Delta$$\lambda$ = {} nm'.format(round(deltaL,3)), xy=(1,1), xytext=(0.02,1), xycoords='axes fraction', fontsize=12)
    ax[0,4].legend(bbox_to_anchor=(1.2, 1), frameon=False, fontsize=10)
